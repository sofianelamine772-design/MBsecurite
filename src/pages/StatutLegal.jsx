        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-8xl font-header font-bold italic uppercase tracking-tighter mb-8 leading-none">
              Statut <span className="text-transparent bg-clip-text bg-gradient-to-b from-gold-light to-gold-dark">Légal</span>
            </h1>
      ...
      <section className="py-32 container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          <LegalCard 
            ...
            content="MB SÉCURITÉ opère sous l'autorisation d'exercice N° AUT-075-2122-08-24-20230841549 délivrée par le CNAPS. C'est l'assurance d'un prestataire vérifié et agréé."
          />
          <LegalCard 
            icon={ShieldCheck}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center py-20 border-t border-white/5">
           <div>
              <h2 className="text-4xl font-header font-bold italic uppercase mb-8">Un Recrutement <br/><span className="text-gold">Ultra-Sélectif</span></h2>
      ...
      <section className="py-32 border-t border-white/5 bg-white/[0.01]">
        <div className="container mx-auto px-6 max-w-4xl">
           <div className="text-center mb-16">
              ...
              <h2 className="text-3xl font-header font-bold uppercase italic">Foire Aux Questions <span className="text-gold">Légales</span></h2>
           </div>
      ...
      <section className="py-32 bg-dark border-t border-white/5">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
             <div className="text-center mb-16">
                <h2 className="text-3xl font-header font-bold uppercase italic mb-4">Engagement de Qualité</h2>
